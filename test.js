...
(function ( $ ) {
    $.fn.widgetize = function(template, options ) {
        ...
        this.getSettings = function(){
            return this.data('morphdomsettings');
        }
        this.setSettings = function(settings){
            if(settings === undefined){
                settings = {};
            }
            if(!this.data('morphdomsettings')){
                this.data('morphdomsettings', {});
            }
            $.extend(this.data('morphdomsettings'), settings);
        }
            ...
            (function(e){
                window.setTimeout(function(){
                    if(self.getSettings().debug){
                        console.log('debug mode is on: ', preProcess(e, template));
                        console.log('debug mode is on: ', self.getSettings().data);
                    }
                    morphdom(e, preProcess(e, template), self.getSettings());
                    if(!$(e).data('ww-init')){
                        init(e, options);
                    } else {
...
},{"morphdom":2,"mustache":3}],2:[function(require,module,exports){
'use strict';
